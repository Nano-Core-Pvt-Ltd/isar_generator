...
extension DartTypeX on DartType {
  IsarType? get _primitiveIsarType {
    if (isDartCoreBool) {
      ...
      if (alias?.element2.displayName == 'byte') {
        return IsarType.byte;
      } else if (alias?.element2.displayName == 'short') {
        return IsarType.int;
      } else {
        return IsarType.long;
      }
    } else if (isDartCoreDouble) {
      if (alias?.element2.displayName == 'float') {
  ...
  bool get isIsarId {
    return alias?.element2.displayName == 'Id';
  }
